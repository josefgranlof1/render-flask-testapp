...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://wings_render_example_user:zroN1A7Z0K71rvz6V9Qe7vtI8kuO9Amj@dpg-ctts2s1opnds73cfm550-a.frankfurt-postgres.render.com/wings_render_example"
