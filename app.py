...
app = Flask(__name__)
app.config[
    'SQLALCHEMY_DATABASE_URI'] = "postgresql://wingit400_render_example_user:bgIwgDP9HTojHcxkPsvi75XZ2412N7Ya@dpg-d3f57vmr433s73aoetmg-a.frankfurt-postgres.render.com/wingit400_render_example"
