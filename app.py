...
app = Flask(__name__)
app.config[
    'SQLALCHEMY_DATABASE_URI'] = "postgresql://wings1001_render_example_user:XuiAsWuCbNWH72WWMRTxUimGOZFKjvBH@dpg-d3dce033fgac738htip0-a.frankfurt-postgres.render.com/wings1001_render_example"
