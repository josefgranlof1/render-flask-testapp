...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://wings1000_render_example_user:AN1Unt7Zus11lrcU9k5yECnWERw8qEhA@dpg-d3dbn2jipnbc73fejrp0-a.frankfurt-postgres.render.com/wings1000_render_example"
