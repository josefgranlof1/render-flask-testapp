...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://location_render_example_user:K4Pv9bMLINISTmuBip5CpnvYQ85tPLFR@dpg-cul63srv2p9s73a46q1g-a.frankfurt-postgres.render.com/location_render_example"
