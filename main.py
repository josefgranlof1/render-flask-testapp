...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://wingsv1_render_example_it9m_user:Gsn67WBtD5Pi25Btc1olcTSFjFh6FJ8r@dpg-cugapr5ds78s738e1kd0-a.frankfurt-postgres.render.com/wingsv1_render_example_it9m"
