...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://userinfo2_render_example_user:WyzZHMRg9jQany13PA8NCsLzDr4nNlTs@dpg-cukuq1tds78s739t85n0-a.frankfurt-postgres.render.com/userinfo2_render_example"
