...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] ="postgresql://wingsv2_render_example_pzle_user:zvUFDxwlOFj0VdttOMIJ94jh3pBnQCN7@dpg-cu591252ng1s73djojp0-a.frankfurt-postgres.render.com/wingsv2_render_example_pzle"
