...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://mytest2_render_example_user:1YT4bkGoEDPg46KpSNhgp3o273HiangH@dpg-cuhki5a3esus73ckvuug-a.frankfurt-postgres.render.com/mytest2_render_example"
