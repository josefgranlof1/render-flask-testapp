...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://wingsv1_render_example_hzdf_user:Wt97wRimVB2jRunWvG35D6RTT27XQge4@dpg-cugaidtds78s738dvg70-a.frankfurt-postgres.render.com/wingsv1_render_example_hzdf"
