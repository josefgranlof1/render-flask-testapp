...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://wingsx4_render_example_user:zNAF71T2g1KympLEMhI3XwyHqySmVju1@dpg-cuh38ojv2p9s73cqfs20-a.frankfurt-postgres.render.com/wingsx4_render_example"
