...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://mytest_render_example_user:shkIFvbgMvSWpzhL8QrKBYJxd4TsNxsl@dpg-cuh6s2hu0jms73fvgqe0-a.frankfurt-postgres.render.com/mytest_render_example"
