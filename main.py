...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://demoapp_render_example_user:WSAequaLxqCstRpQaLgojxsWlAsfCMzH@dpg-cvh99trv2p9s7383iutg-a.frankfurt-postgres.render.com/demoapp_render_example"
