...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://wingsx3_render_example_user:bppjGDIVgf4HV9Tb51AfGjOqWisqILzn@dpg-cuh0tpbv2p9s73cpc66g-a.frankfurt-postgres.render.com/wingsx3_render_example"
